"""Shared test data: a scripted RNG and the scenario data sets used by several test modules."""
...
class ScriptedRng:
	...
	choice() returns the next scripted value (which must be one of the offered candidates),
	or the first candidate when the script is empty. random() returns the next scripted roll,
